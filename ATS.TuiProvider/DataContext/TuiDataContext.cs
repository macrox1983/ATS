...
namespace ATS.TuiProvider.DataContext
{
    ...
    /// </summary>
    public class TuiDataContext : ITuiDataContext
    {
        ...
        private bool Initialize(int cityCount, int hotelCount, int tourCount, int airlineCount)
        {
                ...
                Countries = new Dictionary<int, Country>
            {
                ...
                { 1, new Country(1,"Турция") },
                { 2, new Country(2,"Сомали") },
                { 3, new Country(3,"Индия") },
                { 4, new Country(4,"Тайланд") },
                { 5, new Country(5,"Афганистан") },
                { 6, new Country(6,"Египет") },
                { 7, new Country(7,"Танзания") },
                { 8, new Country(8,"Франция") },
                { 9, new Country(9,"Боливия") },
                { 10, new Country(10,"Куба") },
            };
